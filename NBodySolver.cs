...
namespace nbody
{
    ...
    class NBodySolver
    {
        ...
        // Default constructor
        public NBodySolver(double maxWidth, double maxHeight, int numberOfBodies, double cycleTime, int calculationMode)
        {
        ...
        {
            runtimeOptimizer.CalculateViaParallelForEach(_bodies, rootNode);
        }
